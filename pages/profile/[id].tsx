...
const Profile = ({data}: IProps) => {
  ...
  const videos = showUserVideos ? 'border-b-2':'text-gray-400';
  // if we are not showing videos column then we will show the liked column
  const liked = !showUserVideos ? 'border-b-2':'text-gray-400'; 
